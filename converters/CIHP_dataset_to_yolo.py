        ...
        for gray_value, class_id in class_mapping.items():
            ...
            for label in range(1, num_labels):
                ...
                for contour in contours:
                    ...
                    cv2.polylines(visualization_image, [contour_points], isClosed=True, color=(255, 255, 255), thickness=5)
...
mask_dir = "../datasets/HumanParsingDataset/CIHP/Training/Category_ids"
output_dir = "../datasets/HumanParsingDataset/CIHP/Training/labels"
visualization_dir = "../datasets/HumanParsingDataset/CIHP/Training/visualizations"
