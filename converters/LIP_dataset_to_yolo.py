...
def process_mask_with_unified_classes(mask_path, output_dir, visualization_dir, class_mapping, class_groups):
        ...
        for gray_value, class_id in class_mapping.items():
            ...
            for label in range(1, num_labels):
                ...
                for contour in contours:
                    ...
                    cv2.polylines(visualization_image, [contour_points], isClosed=True, color=(255, 255, 255), thickness=1)
...
mask_dir = "../datasets/HumanParsingDataset/LIP/TrainVal_parsing_annotations/val_segmentations"
output_dir = "../datasets/HumanParsingDataset/LIP/TrainVal_parsing_annotations/val/labels"
visualization_dir = "../datasets/HumanParsingDataset/LIP/TrainVal_parsing_annotations/val/visualizations"
